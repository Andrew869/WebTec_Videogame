...
export default class Help extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(GlobalData.halfWidth, GlobalData.halfHeight+40, 'Al obtener una bota, tu salto aumentará por 5 segundos', {
            fontFamily: 'Alagard', fontSize: 28, color: '#e14e12',
            stroke: '#000000', strokeThickness: 8,
            align: 'center'
        }).setOrigin(0.5).setDepth(1);
        this.add.text(GlobalData.halfWidth, GlobalData.halfHeight+90, 'Obtener rayo aumenta tu velocidad por 5 segundos', {
            fontFamily: 'Alagard', fontSize: 28, color: '#e14e12',
            stroke: '#000000', strokeThickness: 8,
            align: 'center'
        }).setOrigin(0.5).setDepth(1);
        this.add.text(GlobalData.halfWidth, GlobalData.halfHeight+140, 'La pocion verde duplica la puntuacion durante 5 segundos', {
            fontFamily: 'Alagard', fontSize: 28, color: '#e14e12',
            stroke: '#000000', strokeThickness: 8,
            align: 'center'
        }).setOrigin(0.5).setDepth(1);
